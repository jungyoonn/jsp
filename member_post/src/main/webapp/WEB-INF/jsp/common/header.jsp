...
<header class="container-fluid bg-light">
    <div class="container clearfix p-2">
        <a href="${cp}index" class="float-start"><img src="${cp}imgs/logo.png" alt="로고" class="img-fluid" width="250"></a>
...
<nav class="navbar bg-dark navbar-expand-sm">
    <ul class="navbar-nav container justify-content-start">
        <li class="nav-item mx-4"><a class="text-white nav-link" href="${cp}ndex">메인 페이지</a></li>
        <li class="nav-item mx-4"><a class="text-white nav-link" href="${cp}mypage">마이 페이지</a></li>
        <li class="nav-item mx-4"><a class="text-white nav-link" href="${cp}post?category=1">공지사항</a></li>
