                    ...
                    <div class="col-md-3">
                        <div class=" d-grid gap-2 p-3">
	                        <c:if test="${empty member }">
								<a href="signin" class="btn btn-dark btn-block login">로그인</a>
                        	...
                        	<c:if test="${not empty member }">
	                            <p><a href="mypage.html" class="text-dark text-decoration-none"><strong>${member.name}</strong></a>님 환영합니다</p>
	                            <div class="small clearfix">
	                                <a href="logout" class="btn btn-dark btn-sm float-start text-white text-decoration-none">로그아웃</a>
